...
const Nav = () => (
        <div className="barra-nav">
            <ul className="barra-nav_lista">
                ...
                <li className="barra-nav_item"><a className="barra-nav_A" href="#fazemos">O QUE FAZEMOS</a></li>
                ...
                <li className="barra-nav_item"><a className="barra-nav_A" href="#">FALE CONOSCO</a></li>                
            </ul>
        </div>
);
